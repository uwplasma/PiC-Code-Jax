...
params = jnp.array([0.09599999,2042.0353])
print('Objective function: ', func(params))
opt_state = solver.init(params)
for _ in range(5):
 grad = -jax.grad(func)(params)
 updates, opt_state = solver.update(grad, opt_state, params)
 params = optax.apply_updates(params, updates)
 print('Objective function: {:.2E}'.format(func(params)))
 print('Objective function: ' + str(params))
